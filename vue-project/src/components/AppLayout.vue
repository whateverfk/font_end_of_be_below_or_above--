<template>
  <div class="flex h-screen w-full overflow-hidden bg-zinc-950 text-zinc-100">
    ...
    <main class="flex-1 flex flex-col overflow-hidden relative">
      <!-- Top Header -->
      <header class="h-16 flex items-center justify-between px-8 border-b border-white/5 bg-zinc-950/50 backdrop-blur-md z-10">
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="w-10 h-10 rounded-full bg-gradient-to-tr from-teal-500 to-emerald-400 flex items-center justify-center font-bold text-zinc-950">
